        ...
        <div className="index-nav-div">
          <nav>
            ...
            <div className="index-nav-items-div">
              ...
              <a href="verify-certificate.html">
        ...
        <section id="hero-section" className="hero-section">
          <div className="hero-container">
            <div className="hero-div1">
              ...
              <div className="hero-quote">
                <h1>
                  ...
                  our ways. Ask God to help you to be aligned to the center of
                  His will, and remember - as I've heard it said - that 'delay
                  is not denial'." <br />
                  -Pinkie Bagele Taolo.
                </h1>
              </div>
            ...
            <div className="hero-div2">
              <img className="priest-vector-div" src="/priest-vector.svg" alt />
            </div>
          </div>
                ...
                <div className="announce-text">
                  <h1>
                    ...
                    <span className="announcement-content">
                      ...
                      characteristic, or just time]! Our church group, [name of
                      group], is looking for volunteers who [fit the description
                      for the job needed]. [Group name] will be holding an event
                      on [date, time] and is asking for the community to sign up
                      to help
                    </span>
                    <span className="quotes">"</span>
                  </h1>
